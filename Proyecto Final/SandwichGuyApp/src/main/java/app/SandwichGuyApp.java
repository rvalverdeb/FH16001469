...
public class SandwichGuyApp {
    ...
    private JPanel createAreaPanel(String title) {
        ...
        south.add((title.equals("Caja") ? cajaInfo
                : title.equals("Mazo") ? mazoInfo : title.equals("Mano") ? manoInfo : pozoInfo));
    ...
    private String circularToString(CircularList<Carta> cl) {
        ...
        int i = 0;
        for (Carta c : cl) {
            sb.append(String.format("%d:%s ", ++i, c.toString()));
        }
        return sb.toString();
    }
